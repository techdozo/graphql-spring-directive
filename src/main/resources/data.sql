INSERT INTO book (id, name, author, publisher, price, revenue) VALUES (1000,'Zero to One', 'Peter Thiel', 'Crown Business', 16.14, 234567);
INSERT INTO book (id, name, author, publisher, price,revenue) VALUES (1001, 'The Lean Startup', 'Eric Ries', 'VIKIN', 15.80, 114111);
INSERT INTO book (id, name, author, publisher, price,revenue) VALUES (1002,'Sapiens: A Brief History of Humankind','Yuval Noah Harari','Random House Uk', 18.75,223825);
INSERT INTO book (id, name, author, publisher, price,revenue) VALUES (1003, 'Atomic Habits', 'James Clear', 'Avery', 11.98,813780);
INSERT INTO book (id, name, author, publisher, price,revenue) VALUES (1004, 'The Subtle Art of Not Giving a F*ck', 'Mark Manson', 'Harper',12.99,12790);
